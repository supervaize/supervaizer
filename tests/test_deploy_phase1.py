...
class TestDockerManager:
    ...
    @patch("supervaizer.deploy.docker.DockerClient")
    def test_docker_manager_init(self, mock_docker_client):
    ...
    @patch("supervaizer.deploy.docker.DockerClient")
    def test_docker_manager_init_failure(self, mock_docker_client):
    ...
    def test_generate_dockerfile(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch("supervaizer.deploy.docker.DockerClient"):
                manager = DockerManager()
...
class TestStateManager:
    ...
    def test_deployment_state_model(self):
...
class TestUtilityFunctions:
    ...
    @patch("supervaizer.deploy.docker.DockerClient")
    def test_ensure_docker_running(self, mock_docker_client):
    ...
    @patch("supervaizer.deploy.docker.DockerClient")
    def test_ensure_docker_not_running(self, mock_docker_client):
    ...
    @patch("subprocess.run")
    def test_get_git_sha_fallback(self, mock_run):
...
class TestDeploymentDirectory:
    ...
    def test_create_deployment_directory(self):
        """Test deployment directory creation."""
        with tempfile.TemporaryDirectory() as temp_dir:
    ...
    def test_create_deployment_directory_existing_gitignore(self):
