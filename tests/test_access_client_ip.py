...
class TestExtractClientIpNoTrustedProxies:
    ...
    def test_ignores_xff_when_no_trusted_proxies(
        self: "TestExtractClientIpNoTrustedProxies",
    ) -> None:
    ...
    def test_empty_peer_returns_empty(
        self: "TestExtractClientIpNoTrustedProxies",
    ) -> None:
        scope = {"type": "http", "client": ("", 0), "headers": []}
        assert _extract_client_ip(scope) == ""

    def test_malformed_peer_returns_empty(
        self: "TestExtractClientIpNoTrustedProxies",
    ) -> None:
