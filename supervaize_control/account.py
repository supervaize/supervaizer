...
from typing import TYPE_CHECKING, ClassVar, Dict, Any, Union, Optional
import requests
import shortuuid
...
class Account(AccountModel):
    def __init__(self, **kwargs: Any) -> None:
        ...
        The account ID is generated by Supervaize.com and is a shortuuid of the
        account name. The account API key is provided by Supervaize.com and is used
