...
_EXPORTS: dict[str, tuple[str, str | None]] = {
    ...
    "context": ("supervaizer.context", None),
    "ContextCitation": ("supervaizer.context", "ContextCitation"),
    "ContextClient": ("supervaizer.context", "ContextClient"),
    "ContextOpenResponse": ("supervaizer.context", "ContextOpenResponse"),
    "ContextSearchResponse": ("supervaizer.context", "ContextSearchResponse"),
    "ContextSearchResult": ("supervaizer.context", "ContextSearchResult"),
    "ContextScope": ("supervaizer.context", "ContextScope"),
    ...
    "V2A2AController": ("supervaizer.contracts", "V2A2AController"),
    "V2A2AExternalInterop": ("supervaizer.contracts", "V2A2AExternalInterop"),
    "V2A2ATransport": ("supervaizer.contracts", "V2A2ATransport"),
    "V2ActionRequest": ("supervaizer.contracts", "V2ActionRequest"),
    "V2ActionResult": ("supervaizer.contracts", "V2ActionResult"),
    "V2A2UIResourceImportColumn": (
        "supervaizer.contracts",
        "V2A2UIResourceImportColumn",
    ),
    ...
    "V2SurfaceDefinition": ("supervaizer.contracts", "V2SurfaceDefinition"),
